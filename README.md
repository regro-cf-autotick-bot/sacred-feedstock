...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sacred-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14545&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sacred-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sacred` can be installed with:

```
conda install sacred
```

It is possible to list all of the versions of `sacred` available on your platform with:
